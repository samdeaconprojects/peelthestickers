...
function Profile() {
  ...
  return (
    <div className="Page" onTouchStart={(e) => this.touchStart = e.changedTouches[0].clientX}
         onTouchEnd={(e) => {
           const touchEnd = e.changedTouches[0].clientX;
           if (this.touchStart - touchEnd > 50) {
             handleSwipe('left');
           }
           if (touchEnd - this.touchStart > 50) {
             handleSwipe('right');
           }
         }}>
      ...
      <div className="profileContent">
        <div className={`tabContent ${activeTab === 0 ? 'activeContent' : ''}`}>
        ...
        <div className={`tabContent ${activeTab === 1 ? 'activeContent' : ''}`}>
          <h2>Favorites</h2>
          {/* Add your favorite posts or content here */}
        </div>
        <div className={`tabContent ${activeTab === 2 ? 'activeContent' : ''}`}>
          <h2>Stats</h2>
